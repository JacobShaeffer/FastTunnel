...
public class Options {
    ...
    public Options(GameInfoObject gio){
        ...
        buttonOrigY = 512;
        crossesY[0] = buttonOrigY;
        crossesY[1] = buttonOrigY-76;
        crossesY[2] = buttonOrigY-149;
        ...
        buttons[1][1] = buttonOrigY - 6;
        buttons[2][0] = buttonOrigX - 5;
        buttons[2][1] = buttonOrigY - 82;
        buttons[3][0] = buttonOrigX - 5;
        buttons[3][1] = buttonOrigY - 155;
        buttons[4][0] = buttonOrigX - 5;
        buttons[4][1] = buttonOrigY - 229;
        buttons[5][0] = buttonOrigX + 11;
        buttons[5][1] = buttonOrigY - 305;
        ...
        buttRect[4] = new Rectangle(buttons[4][0], buttons[4][1], 32, 32);
        buttRect[5] = new Rectangle(buttons[5][0], buttons[5][1], 251, 25);
        buttRect[6] = new Rectangle(sliderBoxX, sliderBoxY, 267, 26);
    }
    ...
    {//TODO: replace with state value
        if(gio.getTouched())
        {
            for (int i = 0; i < buttRect.length; i++)
            {
                ...
                {
                    if(i > 0){//1 2 3 are crosses
                        if(i > 0 && i < 5 && gio.getTouched())
                        {
                            if(i == 1)
